...
int main(void)
{
    ...
    printf("Данная программа создана для работы со стеком и проверки введенной строки на то, является ли она палиндромом или нет.\n");
    printf("В стек можно добавлять только один символ, при неверном вводе прогрмма предложит ввести символ еще раз.\n");
    printf("Обратите внимание, что максимальный размер стека, который реализован с помощью массива = 1000.\n\n");
